...
def init_parser():
    ...
    parser.add_argument('--arch', type=str, default='swin', choices=MODELS)
    ...
    parser.add_argument('--patch_size', default=2, type=int, help='patch size for ViT')
...
def main(args):
    ...
    num_queries = 100
    dec_layers = 3
    num_patches = int((data_info['img_size'] /(args.patch_size**3)) ** 2) #16
    embed_dim=192

    num_heads = 12
    SwinModel = create_model(data_info['img_size'], 0, args)
    model = utils.MultiCropWrapper(SwinModel,
